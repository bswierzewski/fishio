...
export const getCurrentUserLogbookEntries = (
  ...
  return customInstance<UserLogbookEntryDtoPaginatedList>(
    { url: `/api/logbook`, method: 'GET', params, signal },
    options
  );
};
...
>(
  params: GetCurrentUserLogbookEntriesParams,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCurrentUserLogbookEntries>>, TError, TData>>;
    request?: SecondParameter<typeof customInstance>;
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getCurrentUserLogbookEntries>>> = ({ signal }) =>
    getCurrentUserLogbookEntries(params, requestOptions, signal);
...
export const getLogbookEntryDetailsById = (
  ...
  return customInstance<LogbookEntryDto>({ url: `/api/logbook/${id}`, method: 'GET', signal }, options);
};
...
>(
  id: number,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getLogbookEntryDetailsById>>, TError, TData>>;
    request?: SecondParameter<typeof customInstance>;
  }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getLogbookEntryDetailsById>>> = ({ signal }) =>
    getLogbookEntryDetailsById(id, requestOptions, signal);
...
export type UpdateExistingLogbookEntryMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateExistingLogbookEntry>>
>;
...
export const deleteExistingLogbookEntry = (id: number, options?: SecondParameter<typeof customInstance>) => {
...
export const getDeleteExistingLogbookEntryMutationOptions = <TError = ProblemDetails, TContext = unknown>(options?: {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteExistingLogbookEntry>>, { id: number }> = (
    props
  ) => {
    const { id } = props ?? {};
...
export type DeleteExistingLogbookEntryMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteExistingLogbookEntry>>
>;
...
export const useDeleteExistingLogbookEntry = <TError = ProblemDetails, TContext = unknown>(
  ...
  queryClient?: QueryClient
): UseMutationResult<Awaited<ReturnType<typeof deleteExistingLogbookEntry>>, TError, { id: number }, TContext> => {
