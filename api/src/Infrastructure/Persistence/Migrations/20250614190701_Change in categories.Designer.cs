...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250614190701_Change in categories")]
    partial class Changeincategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fishio.Domain.Entities.CategoryDefinition", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CalculationLogic = "MaxValue",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Nagroda za największą rybę wybranego gatunku (np. Największy Karp). Gatunek wybierany przy dodawaniu kategorii do zawodów.",
                            EntityType = "FishCatch",
                            IsGlobal = true,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Metric = "WeightKg",
